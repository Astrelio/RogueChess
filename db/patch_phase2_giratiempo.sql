-- =============================================================================
-- RogueChess PATCH — Giratiempo: FEN debe conservar el turno extra
-- chess.js deja el turno al rival; si queda movimiento de Giratiempo,
-- reescribimos el side-to-move del FEN al color del jugador.
...
BEGIN
  ...
  -- Si conservamos el turno, el FEN debe decir nuestro color (no el del rival)
  IF v_keep_turn THEN
