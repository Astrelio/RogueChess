...
BEGIN
  ...
  ('bluriel', 'Dimensión Bluriel', 'bluriel',
   'Tras mover, tus piezas se vuelven borrosas/invisibles al rival. El jaque siempre se anuncia.',
   '{"fog_after_move":true,"announce_check":true}'::jsonb, 'niebla', FALSE, 1, TRUE, 2),
